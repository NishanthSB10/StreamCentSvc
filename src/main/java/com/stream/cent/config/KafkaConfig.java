...
public class KafkaConfig {
    ...
    @Bean
    public KafkaTemplate<String, VideoMetadata> kafkaTemplate() {
    ...
    public ConsumerFactory<String, VideoMetadata> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "file-processing-group");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);

        JsonDeserializer<VideoMetadata> deserializer = new JsonDeserializer<>(VideoMetadata.class);
        deserializer.addTrustedPackages("com.content.storage.domain");
